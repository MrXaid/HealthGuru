...
from myadmin.views import prescription_list
from django.contrib.auth import login, authenticate, logout
from django.contrib.auth.decorators import login_required
from django.contrib import messages
from django.views.decorators.cache import cache_control
from hospitals.models import User, Patient, Hospital_Information 
...
from myadmin.models import Admin_Information,Clinical_Laboratory_Technician, Test_Information
...
from myadmin.models import hospital_department, specialization, service

# here we are creating a custom form that inherits from user form (reason --> for modify and customize)
...
def accept_appointment(request, pk):
    ...
    try:
        ...
        send_mail(subject, plain_message, 'zk071342@gmail.com',  [patient_email], html_message=html_message, fail_silently=False)
...
def create_prescription(request,pk):
        if request.user.is_doctor:
            ...
            if request.method == 'POST':
                ...
                if None in [test_name, medicine_name, ...]:  # Add other required fields here
