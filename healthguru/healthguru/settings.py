"""
Django settings for healthguru project.
...
SECRET_KEY = "django-insecure-dc-t8w_45++b$(f1hwrlc02kzbm7@2*4+x@d(6-2ouv7%bdddu"
...
WSGI_APPLICATION = "healthguru.wsgi.application"
