...
from doctors.models import Doctor_Information
from myadmin.models import Admin_Information, Clinical_Laboratory_Technician

from myshop.models import Pharmacist
    ...
    if created:
        if instance.is_patient:
            ...
            Patient.objects.create(
                user=user, username=user.username, email=user.email, serial_number = random_string())
